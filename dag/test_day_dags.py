...
def test_day_dags():
    ...
    # Define tasks
    task_1 = BashOperator(task_id='brush_teeth6', bash_command='echo "Brushed teeth"', retries=3, retry_delay=timedelta(minutes=5))
    task_2 = BashOperator(task_id='eat_breakfast6', bash_command='echo "Ate a healthy breakfast"', retries=3, retry_delay=timedelta(minutes=5))
    task_3 = BashOperator(task_id='exercise6', bash_command='echo "Completed morning exercise"', retries=3, retry_delay=timedelta(minutes=5))
